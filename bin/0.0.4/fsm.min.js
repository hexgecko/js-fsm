...
!0);else for(var h in this._action[f])!0===a.test(f)&&h===b&&(delete this._action[f][h],e=!0)}else for(f in this._action)if(void 0===b)f===a&&(delete this._action[f],e=!0);else for(h in this._action[f])f===a&&h===b&&(delete this._action[f][h],e=!0);!0===e&&void 0!==this._hookTableUpdateCallback&&this._hookTableUpdateCallback(this._action)};FSM.prototype.hookErrorMissingState=function(a){this._hookErrorMissingStateCallback="function"===typeof a?a:void 0};
